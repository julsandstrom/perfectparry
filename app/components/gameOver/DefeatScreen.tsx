  ...
  return (
    <div className="h-full w-full flex flex-col gap-10 lg:gap-20 items-center justify-center">
      ...
      <div className="flex flex-col items-center justify-center gap-10 lg:gap-14">
        <button
          onClick={onRestart}
          className="bg-[#325298] lg:text-xl text-[#F1F1F1] rounded-xs px-6 py-2 w-40 lg:w-60 lg:py-4"
        >
          Try Again
        </button>
        <a
          ...
          className="text-white border-[0.3px] lg:text-xl border-white/20 rounded-xs px-6 py-2 lg:w-60 lg:py-4 inline-block text-center w-40"
        >
          Contact developer
        </a>
      </div>
